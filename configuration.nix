...

{
  ...
  networking.hostName = "binah"; # Define your hostname.
  ...
  #   (particularly a 'phantom' Unknown-1 display appearing)
  boot = {  
    kernelParams = [ 
      "nvidia-drm.fbdev=1" 
    ];
  ...
  # The lua lspconfig line is to activate the nixd language server.
  programs.neovim = {
    enable = true;
    defaultEditor = true;
    viAlias = true;
